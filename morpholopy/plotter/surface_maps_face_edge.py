...
def surface_densities_overview(sim_name, directory, snapshot, catalogue, output_path, halo_id, halo_min_stellar_mass):

        snapshot_filename = directory + '/' + snapshot

        catalogue_filename = glob.glob(directory+catalogue+'*')[0]
        ...
        filename_text_f1 = output_path + '/HIH2transition_'+sim_name+'_'+snapnum+'.dat'
        ...
        filename_text_f2 = output_path + '/Resolved_fundamental_plane_'+sim_name+'_'+snapnum+'.dat'
