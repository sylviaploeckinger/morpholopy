...
def plot_combined_surface_densities(sigma_SFR, sigma_gas, sigma_H2, stellar_mass, siminfo):
...
def plot_combined_density_ratios(galaxy_data, siminfo):
...
def plot_surface_densities(galaxy_data,siminfo):

    # plot surface densities
    plot_combined_surface_densities(galaxy_data.sigma_SFR,galaxy_data.sigma_gas,galaxy_data.sigma_H2,
                           galaxy_data.stellar_mass,siminfo)

    # plot surface densities
    plot_combined_density_ratios(galaxy_data,siminfo)
